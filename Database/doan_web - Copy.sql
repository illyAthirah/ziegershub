...
(48, 'thuy122', 'Products đẹp quá', 71, ''),
...
(56, 'khanhlinh', 'Products đẹp', 81, '31/05/2022');
...
(55, 'Áo Polo Gucci Logo-Patch Shirt Màu Xanh Lá', 40, 18, 'Áo Polo Gucci Logo-Patch Shirt Màu Xanh Lá là chiếc áo thời trang dành cho nam đến từ Brand Gucci nổi tiếng. Với thiết kế hiện đại cùng họa tiết tinh tế nổi bật áoGucci Logo-Patch Shirt được nhiều tín đồ thời trang săn đón.', 0, 11000000, 'a5ce1e5572.jpg', 28, 0),
...
(62, 'Áo Sơ Mi Gucci Cotton Shirt With Symbols Màu Trắng ', 40, 18, 'Áo Sơ Mi Gucci Cotton Shirt With Symbols Màu Trắng là chiếc áo thời trang dành cho nam đến từ Brand Gucci nổi tiếng. Với thiết kế hiện đại cùng họa tiết tinh tế nổi bật áo Gucci Cotton Shirt With Symbols được nhiều tín đồ thời trang săn đón.', 0, 25600000, '0bedfbdb7f.jpg', 29, 0),
...
(73, 'Quần đùi Female', 42, 30, 'Quần đùi lót vải cotton pha cát • Cạp chun co giãn\r\n\r\nvới logo thêu ngược\r\n\r\n Chất liệu: 100% cotton\r\n• Màu trắng\r\n Sản xuất tại: Italy', 1, 4560000, '7ae82fe310.jpg', 39, 0),
...
(91, 'QUẦN TÂY NAM KHAKI DÂY KÉO RÚT', 42, 19, 'Quần khaki ống bo chun co giãn Variation bó, cạp chần chun có dây kéo rút. Có túi phía trước và 2 túi có nắp phía sau.', 0, 1090000, 'bd9400c2f4.jpg', 39, 70),
...
(95, 'ÁO POLO CỔ ĐỨC', 40, 19, 'Với chất vải thun cùng form áo tay ngắn dễ mặc sẽ mang lại cho người mặc cảm Pricec thoải mái, mát mẻ', 0, 790000, '63afc5eb72.jfif', 28, 68),
...
(103, 'QUẦN KHAKI KHỦNG LONG NHÍ', 40, 16, '\r\nQuần Khaki có họa tiết khủng long nhí dễ thương. Dáng quần suông nhẹ, đứng dáng mà vẫn tạo cảm Pricec thoải mái cho con các con. Quần có cạp chun giả khóa kéo, xinh xắn và phù hợp diện hằng ngày.', 2, 390000, '3e372328c0.jfif', 41, 64);
