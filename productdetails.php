...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit'])) {
    if (Session::get('user_login') == false) {
        ...
        if ($_POST['size'] == "") {
            ...
            echo 'alert("You have not selected a size")';
            echo '</script>';
        } else if ($checkQuantity == false) {
            echo '<script type ="text/JavaScript">';
            echo 'alert("This product is out of stock. Please come back later!")';
            echo '</script>';
        } else {
            $size = $_POST['size'];
...
if (isset($_POST['comments']) && $_POST['content'] != "" && $_POST['date_comment'] != "") {
    if (Session::get('user_login') == false) {
        $tb = '<span class="fix_bug">Login required!</span>';
    } else {
        $binhluan = $user->insert_comments();
    }
} elseif (isset($_POST['comments']) && $_POST['content'] == "") {
    $tb = '<span class="fix_bug">You have not entered a comment</span>';
}
...
if (isset($_POST['rep_submit']) && $_POST['rep_content'] != "") {
    ...
    $tb = '<span class="fix_bug">You have not entered a reply</span>';
} elseif (isset($_POST['comments']) && isset($_POST['rep_content']) == ' ') {
    $tb = '<span class="fix_bug">Invalid character!</span>';
} else {
    echo "";
}
?>
                            ...
                            <div class="col l-6">
                                <div class="home-product-icon">
                                    ...
                                    <div class="home-product-item__sales">
										...
										<span class="home-product-item__click">Reviews</span>
										<span class="home-product-item__bot"></span>
										<span class="home-product-item__time">2.4k</span>
										<span class="home-product-item__click">Sold</span>
                                    </div>
                                    <div class="home-product-item__ship">
                                        <span class="home-product-item__ship-title">Shipping</span>
                                        <div class="home-product-item__ship-with">
                                            <p class="home-product-item__ship-content">
                                                <i class="fas fa-truck"></i>
                                                Free Shipping
                                            </p>
                                            <p class="home-product-item__ship-canle">Free shipping for orders over RM50.</p>
                                        </div>
                                    </div>
                                    <div class="all-form-controls">
                                        <form action="" method="post">
                                            <div style="display: flex;align-items: center;">
                                                ...
                                                <a href="" onclick="resgiter(event)" class="navbar-item-link text-bold navbar__item--separate" style="color: #666;">Check your size</a>
                                            </div>
                                                ...
                                                <div class="modal__overlay">
                                                    <div class="model__body">
                                                        <div class="table-size-product" style="display: none" id="table-size-product">
                                                            ...
                                                            <div class="title-table-size">Size Guide Table</div>
                                                            <div class="exclusive-tabs">
                                                                <div class="exclusive-head">
                                                                    <ul>
                                                                        <li class="exclusive-tab " onclick="changeBestSeller('men',this)">Male</li>
                                                                        <li class="exclusive-tab  active " onclick="changeBestSeller('women',this)">Female</li>
                                                                        <li class="exclusive-tab " onclick="changeBestSeller('kids',this)">Kids</li>
                                                                    </ul>
                                                                </div>
                                                                            ...
                                                                            <div class="col l-12">
                                                                                <table class="table-pc" style="width: 100%;">
                                                                                    ...
                                                                                    <tbody>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td colspan="6"><b>* Measurements in the "SPECIFICATION CHART" are body measurements, not clothing measurements.</b></td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>
                                                                            </div>
                                            ...
                                            <div style="padding: 20px 0;color: black;">
                                                ...
                                                ?>
                                                    <span>Product quantity (<?php echo $result_Details['quantity'] ?> left)</span>
                                                    <?php
                                                } else {
                                                ?>
                                            ...
                                            <div class="price-product">
                                                <span>Price</span>
                                                <span><?php echo "RM" . number_format($result_Details['price'], 2, '.', '')?></span>
                                            </div>
                                            <!-- hiên thị thông báo Products đã được cập nhật nếu đã có trong Shopping cart -->
                                            <div>
                                                <?php
                                                if (isset($addToCart)) {
                                                    $size = $_POST['size'];
                                                    ...
                                                    echo '<span style="color:red;">The product already exists in the cart, size and quantity have been updated.</span>';
                                                }
                                                ?>
                                            </div>
                                            <div style="text-align: center;padding: 40px;align-items: center; display: flex; justify-content: center;     border-bottom: 1px solid #ccc;">
                                                ...
                                                if (Session::get('user_login') == false) {
                                                ?>
                                                    <input type="button" value="Add Products" class="btn--primary" onclick="swal_login_false()"><i class="fas fa-cart-plus" style="margin-left:10px; font-size:48px;"></i></input>
                                                <?php
                                                } else {
                                                ?>
                                                    <input type="submit" name="submit" value="Add Product" class="btn--primary"><i class="fas fa-cart-plus" style="margin-left:10px; font-size:48px;"></i></input>
                                                <?php
                                            ...
                                            <div class="app_content">
                                                <div class="home-title">
                                                    <h4 class="home-title-all">Product Details</h4>
                ...
                <div class="comment" style="border: 1px solid #ccc;border-radius: 10px;padding: 10px;">
                    <section style="border-bottom: 1px solid #ccc;">
                        ...
                        <div style="display: flex;">
                            <h2 class="comment-title">Comment
                        </div>
                        <?php
                        if (isset($binhluan)) {
                            echo $binhluan;
                        ...
                        <form action="" method="post">
                            <div style="display: flex;align-items: center;justify-content: space-between;">
                                ...
                                <section style="width: 90%;">
                                    <input pattern="\S+.*" autocomplete="off" class="comment-tacontent" name="content" placeholder="Enter comment content..."></input>
                                </section>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="sort_comment">
                                    <?php echo $count_comment ?> Comment
                                </div>
                            </div>
                        </form>
                    </section>
            ...
            <div class="related_products">
                <h3>Related products</h1>
                    <div class="row">
                        ...
                        ?>
                                <div class="col l-2-4">
                                    <a href="productdetails.php?productId=<?php echo $result['productId'] ?>&&brandId=<?php echo $result['brandId'] ?>&&type=<?php echo $result['type'] ?>">
                                        <div class="home-product-item">
                                            ...
                                            <div class="home-product-item_price">
                                                <span class="home-product-item_price-current"><?php echo "RM" . number_format($result['price'], 2, '.', '0')?></span>
                                            </div>
                                        </div>
                                    </a>
                                </div>
