...
// Add sản phẩm vào Shopping cart
                                ...
                                <div class="home-product-icon">
                                    ...
                                    <div class="all-form-controls">
                                        <form action="" method="post">
                                            ...
                                            <!-- hiên thị thông báo sản phẩm đã được cập nhật nếu đã có trong Shopping cart -->
                                            <div>
                                                <?php
                                                if (isset($addToCart)) {
                                                    $size = $_POST['size'];
                                            ...
                                            <div style="text-align: center;padding: 40px;align-items: center; display: flex; justify-content: center;     border-bottom: 1px solid #ccc;">
                                                ...
                                                if (Session::get('user_login') == false) {
                                                ?>
                                                    <input type="button" value="Add sản phẩm" class="btn--primary" onclick="swal_login_false()"><i class="fas fa-cart-plus" style="margin-left:10px; font-size:48px;"></i></input>
                                                <?php
                                                } else {
                                                ?>
