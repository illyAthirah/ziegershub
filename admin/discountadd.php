...
<head>
    ...
    <title>Customer Codeuyến mãi</title>
</head>
...
<body>
    ...
    <div class="main-content">
        ...
        <main>
            <h2 class="dash-title">Nhập Discount code</h2>
                            ...
                            <div class="activity-card col l-9">
                                <div>
                                    <div class="discount_title">
                                        <label for="">Tên Discount code</label>
                                    </div>

                                    <div class="discount_name">
                                        <input type="text" name="coupon_name" id="" placeholder="Enter Name Discount code">
                                    </div>
                                    <div class="discount_title">
                                    ...
                                    <div class="discount_name">
                                        <input type="text" name="coupon_code" id="" placeholder="Nhập Discount code">
                                    </div>
                                </div>
                            </div>
