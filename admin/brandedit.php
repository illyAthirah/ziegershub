            ...
            <div class="activity-grid">
                <div class="activity-card">
                    ...
                    <table class="form" style="border-collapse: inherit;">					
                        <tr>
                            <td>
                                <input type="text" value="<?php echo $result['brandName']  ?>" name="brandName" placeholder="Edit Products" class="medium" style="width: 50%;text-align: center;padding: 10px;border-radius: 6px;font-size: 20px;" />
                            </td>
                        </tr>
						<tr> 
                            <td>
