								...
								<form action="" method="GET">
									<div class="sort_price" style="display: flex;">										
										<select class="select-input" name="select" onchange="location = this.value;">																			
											<option value="timkiemnangcao.php">Choose by price</option>											
												<option value="timkiemnangcao.php?select=low-high" <?php if(isset($_GET['select']) && $_GET['select'] == 'low-high'){echo "selected";} ?>>Price: Low to High</option>																		
												<option value="timkiemnangcao.php?select=high-low" <?php if(isset($_GET['select']) && $_GET['select'] == 'high-low'){echo "selected";} ?>>Price: High to Low</option>
										</select>
									</div>
								</form>
							</div>
