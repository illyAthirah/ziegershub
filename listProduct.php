                        ...
                        <div class="col l-12">
                            <div class="home-filter">
                                <div class="home-filter__page">
                                    <div class="sm-gutter app__header">
                                        <span class="title-direct"><a href="index.php">Home/</a></span>
                            ...
                            <div class="home-suggestion">
                                <div class="row">
                                    ...
                                    ?>
                                            <div class="col l-3">
                                                <a style="text-decoration: none;shape-rendering: #333;color: #333;" href="productdetails.php?productId=<?php echo $result['productId'] ?>&&brandId=<?php echo $result['brandId']?>&&type=<?php echo $result['type']?>">
                                    ...
                                    <?php
                                        ...
                                        ?>
                                        <div style="margin:20px auto;">No product found</div>
                                    <?php
                                    }
                                    ?>
                                </div>
