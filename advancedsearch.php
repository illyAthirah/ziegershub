							...
							<form action="" method="GET">
								<div id=""  class="tim-kiem-nang-cao">
									...
									<div style="width: 100%; text-align: center;">
										<input class="tim-kiem-nang-cao-input" type="submit" name="submit" value="Search" />
									</div>
								</div>
							 </form> 
						</div>
								...
								<form action="" method="GET">
									<div class="sort_price" style="display: flex;">										
										<select class="select-input" name="select" onchange="location = this.value;">																			
											<option value="advancedsearch.php">Choose by price</option>											
												<option value="advancedsearch.php?select=low-high" <?php if(isset($_GET['select']) && $_GET['select'] == 'low-high'){echo "selected";} ?>>Price: Low to High</option>																		
												<option value="advancedsearch.php?select=high-low" <?php if(isset($_GET['select']) && $_GET['select'] == 'high-low'){echo "selected";} ?>>Price: High to Low</option>
										</select>
									</div>
								</form>
							</div>
														...
														<div class="col l-4">
															...
															<div class="home-product-item">
																...
																<div class="home-product-item_price">
																	<span class="home-product-item_price"><?php echo "RM" . number_format($result['price'],2,'.','')?></span>
																</div>
															</div>
														</a>
														</div>														
										...
										while($result = $product_spr->fetch_assoc()){
											...
											<div class="col l-4">
												...
												<div class="home-product-item">
													...
													<span class="home-product-item_name"><?php echo $result['productName'] ?></span>
													<div class="home-product-item_price">
														<span class="home-product-item_price"><?php echo "RM" . number_format($result['price'],0,',','.') ?></span>
													</div>
												</div>
											</a>
											</div>	
