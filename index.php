											...
											<a href="productdetails.php?productId=<?php echo $result['productId'] ?>&&brandId=<?php echo $result['brandId'] ?>&&type=<?php echo $result['type'] ?>">
												<div class="home-product-item">
													<div class="ovelay-img">
														...
														<div class="overlay">
															<!--buy-btn------>
															<a href="productdetails.php?productId=<?php echo $result['productId'] ?>&&brandId=<?php echo $result['brandId'] ?>&&type=<?php echo $result['type'] ?>" class="buy-btn">Buy Now</a>
														</div>
													</div>
													<h4 class="home-product-item_name"><?php echo $result['productName'] ?></h4>
													<div class="home-product-item_price">
														<span class="home-product-item_price-current"><?php echo "RM" . number_format($result['price'], 2, '.', '') ?></span>
													</div>
														<span style="margin-left:200px;font-family: var(--font-family-sans-serif);font-weight: 600;">Sold: <?=$result['quantitysales']?></span>
												</div>
											</a>
										</div>
									<?php
							...
							<div class="ds-flex-container">
								<div class="ds-flex-item-image col l-5">
									...
									<div class="ds-flex-item-text">
										...
										<h3 class="medium-style">Becca Hiller is a female model represented by MGM Models.</h3>
									</div>
								</div>
