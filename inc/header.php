            ...
            <ul>
                ...
                <li class="header__search">
                    <form action="advancedsearch.php" method="GET">
                        ...
                        ?>
                        <input type="text" name="search" class="header__search-input" placeholder="Search...">
                ...
                <li class="header__cart-wrap1">
                    <div class="header__cart">
                        ...
                        <div class="header__cart-list header__cart-list--no-cart">
                            <h5 class="header__cart-list-title" id="style_1">Product information</h5>
                            <?php
                                $cart = new cart();
                            ...
                            <div class="header__cart-list-cart">
                                ...
                                <div class="header__cart-list-cart-price">
                                    <span><?php echo "RM" . number_format($result['price'], 2, '.', '')?></span>
                                </div>
                            </div>
                            <?php
                                    }
                ...
                <li  class="nav-list">
                    <div class="nav-account">
                        ...
                        <ul class="nav-user_menu">
                            ...
                            <li class="nav-user_menu-item">
                                <a style="color: #ffffff;  font-size: 14px; font-weight: 600; text-decoration: none; font-family: var(--font-family-monospace);
                                " href="orders.php">Order management</a>
                            </li>
                            <li class="nav-user_menu-item">
